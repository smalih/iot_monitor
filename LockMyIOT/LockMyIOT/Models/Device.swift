...
extension Device {
    ...
    static let mockDevices: [Device] = [
        ...
        Device(id: 3, name: "Unknown Device", type: .other, ipAddress: "192.168.1.30", macAddress: "00:1C:2D:3E:4F:5A", status: .unsecure),
        Device(id: 4, name: "MacBook Pro", type: .phone, ipAddress: "192.168.1.40", macAddress: "00:1D:2E:3F:4A:5B", status: .secure),
        Device(id: 5, name: "Amazon Echo", type: .speaker, ipAddress: "192.168.1.50", macAddress: "00:1E:2F:3A:4B:5C", status: .unsecure),
        Device(id: 6, name: "Android Tablet", type: .phone, ipAddress: "192.168.1.60", macAddress: "00:1F:2A:3B:4C:5D", status: .secure),
        Device(id: 7, name: "Unrecognized IoT Device", type: .other, ipAddress: "192.168.1.70", macAddress: "00:2A:3B:4C:5D:6E", status: .unsecure),
        ...
        Device(id: 10, name: "Random Smart Device", type: .other, ipAddress: "192.168.1.100", macAddress: "00:2D:3E:4F:5A:7B", status: .unsecure)
    ]
}
